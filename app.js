...
if (localStorage.getItem("stdArr")) {
    ...
    stdArr = [
      {fname: 'John ', lname: 'Doe', email: 'john@gmail.com', contact: '1234567788', stdId: '97709675-eead-4903-9421-e9bedc0461b8'},
      {fname: 'Mary ', lname: 'Smith', email: 'may@gmail.com', contact: '9876543210', stdId: 'c3f2f5d2-1e4b-4f7a-8f12-17e4f6d2b8a4'},
    ];
}
cl(stdArr)
